<?php
  ...
  if (filter_has_var(INPUT_POST,'btnSoumettre')) {
    if (condition) {
      // code...
    }
  }
...
<div class="w3-top">
  <div class="w3-bar w3-white w3-wide w3-padding w3-card">
    <a href="" class="w3-bar-item w3-button"><b>Imprimante 3D</a>
...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="w3-container w3-padding-32" id="contact">
    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Formulaire de demande</h3>
    <p><?php echo $erreur; ?></p>
    <form action="" method="POST">
      <input class="w3-input w3-border" type="text" placeholder="Nom de la pièce" required name="nomPiece">
      <textarea class="w3-input w3-section w3-border" name="descPiece" required placeholder="Description de la pièce"></textarea>
      <input class="w3-button w3-black w3-section" type="submit" name="btnSoumettre" value="SOUMETTRE DEMANDE">
    </form>
  </div>

  <!-- Project Section -->
  <!--<div class="w3-container w3-padding-32" id="projects">
    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Journal d'impression</h3>
  </div>
